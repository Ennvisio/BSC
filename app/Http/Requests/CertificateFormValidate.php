...
/**
 * A vessel's own certificate, recorded in one go by its Master/Chief
 * Engineer: category + title + dates + how it renews.
 */
class CertificateFormValidate extends FormRequest
{
    ...
    public function rules()
    {
        return [
           ...
           // Either of these is enough for a certificate that expires: give
           // the renewal period and the date is worked out
           // (HomeController::expiryDateFor), or give the date outright -
           // which is how every record predating this form was entered, and
           // they still have to be editable. Enforced in withValidator below.
