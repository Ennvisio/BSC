...
<aside class="srd-sidebar">
  ...
  <a href="{{url('/home/survey')}}" class="srd-nav-item {{Route::current()->uri() == 'home/survey' ? 'active' : ''}}"><i class="fas fa-clipboard-check"></i>Surveys<span class="srd-nav-count">{{ \App\Survey::where('status',true)->count() }}</span></a>
  ...
  <a href="{{url('/home/item')}}" class="srd-nav-item {{Route::current()->uri() == 'home/item' ? 'active' : ''}}"><i class="fas fa-box"></i>Items<span class="srd-nav-count">{{ \App\Item::where('status',true)->count() }}</span></a>
  <a href="{{url('/home/order')}}" class="srd-nav-item {{Route::current()->uri() == 'home/order' ? 'active' : ''}}"><i class="fas fa-clipboard-list"></i>Requisitions</a>
  @endif
  ...
  <a href="{{url('/home/order')}}" class="srd-nav-item {{Route::current()->uri() == 'home/order' ? 'active' : ''}}"><i class="fas fa-clipboard-list"></i>Add Requisition</a>
  <a href="{{url('/approved/requisition')}}" class="srd-nav-item {{Route::current()->uri() == 'approved/requisition' ? 'active' : ''}}"><i class="fas fa-clipboard-check"></i>Approved/Sent Requisition</a>
  ...
  <a href="{{url('/approved/requisition')}}" class="srd-nav-item {{Route::current()->uri() == 'approved/requisition' ? 'active' : ''}}"><i class="fas fa-clipboard-check"></i>Approved Requisition</a>
  <a href="{{url('/received/requisition')}}" class="srd-nav-item {{Route::current()->uri() == 'received/requisition' ? 'active' : ''}}"><i class="fas fa-inbox"></i>Received Requisition</a>
  @endif
