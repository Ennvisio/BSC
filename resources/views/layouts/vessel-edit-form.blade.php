<div class="vessel-form">
	...
	<ul class="nav nav-tabs" id="myTab" role="tablist">
		<li class="nav-item">
			<a class="nav-link active" id="v-general-tab" data-toggle="tab" href="#v-general" role="tab" aria-controls="v-general" aria-selected="false">General Info</a>
		</li>

		<li class="nav-item">
			@if(empty($vessel))
				<a style="pointer-events: none;cursor: default;opacity: 0.6;" class="nav-link" id="v-particulars-tab" data-toggle="tab" href="#v-particulars" role="tab" aria-controls="v-particulars" aria-selected="false">Particulars</a>
			@else
				<a class="nav-link" id="v-particulars-tab" data-toggle="tab" href="#v-particulars" role="tab" aria-controls="v-particulars" aria-selected="false">Particulars</a>
			@endif
		</li>
	...
	<div class="tab-content" id="myTabContent">
			   ...
			   <div class="bsc-form-wrapper vasel-ginfo-wrapper">
                    ...
                    <form id="v-geninfo-form">   
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="vessel_name" value="{{ !empty($vessel->name) ? $vessel->name :''}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control text-uppercase" name="vessel_acronym" maxlength="5" placeholder="e.g. JOY" value="{{ $vessel->acronym ?? '' }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="owner_name" value="{{ !empty($vessel->owner_name) ? $vessel->owner_name :''}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="owner_address" value="" >{{ !empty($vessel->owner_address) ? $vessel->owner_address :''}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="manager_name" value="{{ !empty($vessel->manager_name) ? $vessel->manager_name :''}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="manager_address" value="" >{{ !empty($vessel->manager_address) ? $vessel->manager_address :''}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="master_name" value="{{ !empty($vessel->master_name) ? $vessel->master_name :''}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="master_certificate_no" value="{{ !empty($vessel->master_cert_no) ? $vessel->master_cert_no :''}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control date" name="master_certificate_validity" value="{{ !empty($vessel->master_cert_validity) ? $vessel->master_cert_validity :''}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="cheif_engineer_name" value="{{ !empty($vessel->ch_eng_name) ? $vessel->ch_eng_name :''}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row"> 
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="cheif_engineer_certificate_no" value="{{ !empty($vessel->ch_eng_cert_no) ? $vessel->ch_eng_cert_no :''}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control date" name="cheif_engineer_certificate_validity" value="{{ !empty($vessel->ch_eng_cert_validity) ? $vessel->ch_eng_cert_validity :''}}" >
                            </div>
                        </div>
                        <div class="form-group row mt-4">
		...
		<!-- /tab-pane	 -->
		<!-- tab-pane -->
		<div class="tab-pane fade show" id="v-particulars" role="tabpanel" aria-labelledby="v-particulars-tab">
